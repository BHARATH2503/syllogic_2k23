...
export default function Paper(){
    ...
    <div className='paper'>
        ...
        <ul>
          ...
          <li>The ppt must be submitted on or before 18.03.2023 to the given mail id</li>
          <li>Mail ID - syllogic23.paper@gmail.com </li>
          <li>No of max slides 10 - 12.</li>
          <li>Abstract should be submitted in registration form </li>
         ...
         <div className='col-lg-6 my-auto' id='reg'>
            ...
            <a href="https://forms.gle/Rw5BmqNRn8ZGXymS8" target="_blank" rel="noreferrer noopenner"><button className="btn btn-warning mt-3" id='bb'>Register</button></a>
        </div>
        </div></div>
    </div>
    )
